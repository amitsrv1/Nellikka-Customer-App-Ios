                      ...
                      child: Column(children: [
                                    ...
                                    child: Center(
                                      child: Row(
                                        children: [
                                          ...
                                          size: 20 ,),
                                          Text(controller.walletLogModel.totalCredit.toString(),
                                          textAlign: TextAlign.center,
                                          style: GoogleFonts.roboto(
                                        fontSize: 25,
                                    ...
                                    child: Center(
                                      child: Row(
                                        children: [
                                          ...
                                          color: Color(0xFF59597C),
                                          size: 20 ,),
                                          Text(controller.walletLogModel.totalDebit.toString(),
                                          textAlign: TextAlign.center,
                                          style: GoogleFonts.roboto(
                                        fontSize: 25,
                                        fontWeight: FontWeight.w400,
                        ...
                        const SizedBox(height: 10,),
                          ...
                          Expanded(
                            ...
                            itemCount: controller.walletLogModel.walletLog!.length,
